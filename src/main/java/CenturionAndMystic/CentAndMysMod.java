...
import CenturionAndMystic.util.EnergyGainManager;
...
import CenturionAndMystic.cards.other.cardvars.SecondMagicNumber;
...
@SpireInitializer
public class CentAndMysMod implements
        EditCardsSubscriber,
    ...
    public static EnergyGainManager energyGainManager = null;
    ...
    public CentAndMysMod() {
        BaseMod.subscribe(this);

        BaseMod.addColor(CenturionAndMystic.Enums.CENTURION_COLOR, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        CentAndMysMod thismod = new CentAndMysMod();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CenturionAndMystic(CenturionAndMystic.characterStrings.NAMES[1], CenturionAndMystic.Enums.CENT_AND_MYS),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, CenturionAndMystic.Enums.CENT_AND_MYS);
    }
    ...
    public void receiveStartGame() {
        if (AbstractDungeon.player.chosenClass == CenturionAndMystic.Enums.CENT_AND_MYS) {
            energyGainManager = new EnergyGainManager();
        } else {
            energyGainManager = null;
        }
    }

    @Override
    public void receivePostDungeonUpdate() {
        if (energyGainManager != null) {
            energyGainManager.update();
        }
    }
