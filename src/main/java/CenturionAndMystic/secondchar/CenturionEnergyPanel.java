...
public class CenturionEnergyPanel implements CustomSavable<Integer> {
    ...
    private static final Texture LAYER_0 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/layer1.png"), true);
    private static final Texture LAYER_1 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/layer2.png"));
    private static final Texture LAYER_2 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/layer3.png"));
    private static final Texture LAYER_3 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/layer4.png"));
    private static final Texture LAYER_4 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/layer5.png"));
    private static final Texture LAYER_5 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/layer6.png"), true);
    private static final Texture FLASH_TEXTURE = ImageMaster.loadImage(CentAndMysMod.makeImagePath("char/mainChar/orb/vfx.png"));
