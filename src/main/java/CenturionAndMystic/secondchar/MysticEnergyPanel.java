package CenturionAndMystic.secondchar;
...
public class MysticEnergyPanel implements CustomSavable<Integer> {
    ...
    private static final Texture LAYER_0 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/layer0.png"), true);
    private static final Texture LAYER_1 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/layer1.png"));
    private static final Texture LAYER_2 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/layer2.png"));
    private static final Texture LAYER_3 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/layer3.png"));
    private static final Texture LAYER_4 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/layer4.png"));
    private static final Texture LAYER_5 = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/layer5.png"), true);
    private static final Texture FLASH_TEXTURE = ImageMaster.loadImage(CentAndMysMod.makeImagePath("EnergyPanel/Mystic/flash.png"));
    ...
    public void render(SpriteBatch sb, float x, float y) {
        float drawX = x - 64.0F;
        float drawY = (y + 135*1.15F * Settings.scale) - 64.0F;
